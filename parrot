...
local menu
do
    local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/zappy-L/Cripware.xyz/main/FixedLibrary"))()

    menu = library.new([[Tropicalware X <font color="rgb(78, 93, 234)">$V1.0</font>]], "nemv2\\")
    local tabs = {
